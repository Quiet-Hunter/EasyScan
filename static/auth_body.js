...
//
+' </div><div class="btn-group btn-group-justified">  <a href="#" class="btn btn-primary" id="info">Info</a>  <a href="#" class="btn btn-primary" id="inj">Injections</a>  <a href="#" class="btn btn-primary" id="badauth">Bad Auth</a>  <a href="#" class="btn btn-primary" id="xss">XSS</a>  <a href="#" class="btn btn-primary">Direct Access</a>  <a href="#" class="btn btn-primary">CSRF</a>  <a href="#" class="btn btn-primary">Known Vuls</a>  <a href="#" class="btn btn-primary">Unsecure Reds</a> </div>						</form>	  '
